...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['id']) && isset($_POST['cnpj']) && isset($_FILES["arquivos"])) {
        ...
        $diretorio_destino = "arquivos/" . $cnpj . "/";
        ...
        if ($Controle->arquivoFaculdade($id, $caminhos_arquivos)) {
            ...
            header("Location: ../../faculdade-dados?id=".$id."&error=true");
            exit(); // Encerra o script para evitar a execução de código adicional
        }
    } else {
